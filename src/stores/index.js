...
const debug = require('debug')('mongodb-compass:stores:compy');

/**
 * Compy store.
 */
const CompyStore = Reflux.createStore({
  /**
  ...
  /**
   * Initialize the Compy store state. The returned object must
  ...
  storeDidUpdate(prevState) {
    debug('Compy store changed from', prevState, 'to', this.state);
  }
});

module.exports = CompyStore;
